...
namespace TweetBL
{
    ...
    public class TweetService
    {
        ...
        private static string relativePath = System.Web.HttpContext.Current.Server.MapPath("~") + "TweetDBFile.dat";
        ...
        public TweetService()
        {
            if (File.Exists(relativePath))
            {
                ...
                using (var stream = new FileStream(relativePath, FileMode.Open, FileAccess.Read, FileShare.Read))
                {
        ...
        {
            var formatter = new BinaryFormatter();
            using (var stream = new FileStream(relativePath, FileMode.Create, FileAccess.Write))
            {
